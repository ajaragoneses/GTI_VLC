...
#define CONFIGURE_LINE "../extras/package/win32/../../../configure  '--enable-update-check' '--enable-lua' '--enable-faad' '--enable-flac' '--enable-theora' '--enable-twolame' '--enable-quicktime' '--enable-avcodec' '--enable-merge-ffmpeg' '--enable-dca' '--enable-mpc' '--enable-libass' '--enable-x264' '--enable-schroedinger' '--enable-realrtsp' '--enable-live555' '--enable-dvdread' '--enable-shout' '--enable-goom' '--enable-caca' '--disable-sdl' '--enable-qt' '--enable-skins2' '--enable-sse' '--enable-mmx' '--enable-libcddb' '--enable-zvbi' '--disable-telx' '--enable-nls' '--host=i686-w64-mingw32' '--disable-x265' '--disable-opencv' '--disable-taglib' '--disable-gnutls' '--enable-debug' '--enable-static' 'host_alias=i686-w64-mingw32' 'PKG_CONFIG_LIBDIR=/home/gti/Escritorio/vlc_2/vlc/contrib/i686-w64-mingw32/lib/pkgconfig'"
...
/* compiler */
#define VLC_COMPILER "gcc version 4.8.2 (GCC)"

/* user who ran configure */
#define VLC_COMPILE_BY "gti"

/* host which ran configure */
#define VLC_COMPILE_HOST "gti-HP-Z820-Workstation"
